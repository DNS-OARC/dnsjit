...
assert(ipsplit:discarded() == 0, "some valid packets have been discarded")
assert(out1:size() + out2:size() == 91, "out1: some IPv6 packets lost by filter")
...
while true do
    ...
    if i == 1 then check_dns_msgid(obj, 0x0a31, "pkt 1: client 1, pkt 1 -> out1") end
    if i == 2 then check_dns_msgid(obj, 0xe6bd, "pkt 2: client 2, pkt 1 -> out1") end
    if i == 3 then check_dns_msgid(obj, 0xb3e8, "pkt 3: client 3, pkt 1 -> out1") end
    if i == 4 then check_dns_msgid(obj, 0xb3e9, "pkt 4: client 3, pkt 2 -> out1") end
    if i == 5 then check_dns_msgid(obj, 0x0a6f, "pkt 9: client 6, pkt 1 -> out1") end
end
...
while true do
    ...
    if i == 1 then check_dns_msgid(obj, 0xaac6, "pkt 5: client 4, pkt 1 -> out2") end
    if i == 2 then check_dns_msgid(obj, 0xaea6, "pkt 6: client 5, pkt 1 -> out2") end
    if i == 3 then check_dns_msgid(obj, 0xaea7, "pkt 7: client 5, pkt 2 -> out2") end
end
